...
export interface ApiApplicationLogApplicationLog
  extends Struct.CollectionTypeSchema {
  collectionName: 'application_logs';
  info: {
    displayName: 'Application Log';
    pluralName: 'application-logs';
    singularName: 'application-log';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    applicantIP: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    isWeekendOpen: Schema.Attribute.Boolean;
...
export interface ApiJobListingJobListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    applicationCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    city: Schema.Attribute.String;
    company: Schema.Attribute.Relation<
      'oneToOne',
      'api::company-profile.company-profile'
    ...
    disabilityFriendly: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    district: Schema.Attribute.String;
    educationRequirement: Schema.Attribute.Enumeration<
      [
        '\u0130lk\u00F6\u011Fretim',
        'Orta\u00F6\u011Fretim',
        'Lise',
    ...
    employmentType: Schema.Attribute.Enumeration<
      ['Tam Zamanl\u0131', 'D\u00F6nemsel', 'Yar\u0131 Zamanl\u0131']
    >;
    gender: Schema.Attribute.Enumeration<
      ['Belirsiz', 'Erkek', 'Kad\u0131n', 'Farketmez']
    >;
    jobNature: Schema.Attribute.RichText;
    jobStatus: Schema.Attribute.Enumeration<['Active', 'Expired', 'Pending']> &
      Schema.Attribute.Required &
    ...
    >;
    publicationEndDate: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    requiredQualifications: Schema.Attribute.RichText;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    work_mode: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiPostingRightPostingRight
  extends Struct.CollectionTypeSchema {
  collectionName: 'posting_rights';
  info: {
    displayName: 'Posting Right';
    pluralName: 'posting-rights';
    singularName: 'posting-right';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    activePostings: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    company: Schema.Attribute.Relation<
      'oneToOne',
      'api::company-profile.company-profile'
    >;
    ...
    > &
      Schema.Attribute.Private;
    postingQuota: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    postingsUsed: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    totalApplicationCount: Schema.Attribute.Integer &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u015Eirket hizmetleri listesi';
...
export interface ApiWorkModeWorkMode extends Struct.CollectionTypeSchema {
  collectionName: 'work_modes';
  info: {
    displayName: 'Work Mode';
    pluralName: 'work-modes';
    singularName: 'work-mode';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::application-log.application-log': ApiApplicationLogApplicationLog;
